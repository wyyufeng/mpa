...
exports.default = (function (_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.appReducer, appReducer = _c === void 0 ? {} : _c, _d = _b.middlewares, middlewares = _d === void 0 ? [] : _d;
    var _store;
    var _hasRun = false;
    var _actions = {};
    var _effect = [];
    ...
    function run() {
        ...
        // 1.
        var store = create({
            appReducer: __assign({}, createReducers(), appReducer),
    ...
    function createReducerFunc(model) {
        ...
        var reducerFunMap = Object.keys(reducer).reduce(function (a, b) {
            ...
            _actions[namespace] = __assign({}, _actions[namespace], (_a = {}, _a[b] = actionCreator(model.namespace + "/" + b), _a));
        ...
        return function rootSaga() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, effects_1.all(_effect.map(effects_1.fork))];
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    function create(_a) {
        var _b = _a.middlewares, middlewares = _b === void 0 ? [] : _b, appReducer = _a.appReducer;
        if (process.env.NODE_ENV === "development") {
            middlewares.push(redux_logger_1.logger);
        }
        var store = redux_1.createStore(redux_1.combineReducers(appReducer), composeEnhancers(redux_1.applyMiddleware.apply(void 0, middlewares)));
        return store;
    }
});
